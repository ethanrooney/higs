...
HINDACore::HINDACore(G4String CoreName, G4double height, G4double gap)  //Added LSM 05-19-11
{
  ...
  //SetDimensions();
  SetDimensions(height, gap);  //Added LSM 05-19-11
  BuildCore();
  BuildPMT();
  SetVisAtt();
  AssembleParts();
...
void HINDACore::SetDimensions(G4double height, G4double gap)  //Added LSM 05-19-11
{
  ...
  //NaIDiameter=10*in;
  NaIDiameter=10.375*in;  //rough measurement LSM 08-17-11
  NaIRadius=NaIDiameter/2.0;
  //NaILength=10*in;
  NaILength=height*in;  //Added LSM 05-19-11
  NaIHalfHeight=NaILength/2.0;

  Offset = gap*in;  //Added LSM 05-19-11
...
void HINDACore::AssembleParts()
{
  ...
  */
  G4ThreeVector posNaI = G4ThreeVector(0,0,6*in+Offset+NaIHalfHeight);  //Added LSM 05-19-11
  G4ThreeVector posCoreCan = G4ThreeVector(0,0,6*in+Offset+NaIHalfHeight);  //Added LSM 05-19-11
  G4ThreeVector posQuartzWindow = G4ThreeVector(0,0,6*in+Offset+NaIHalfHeight+(CanShellHalfHeight+BackPlateHalfHeight));  //Added LSM 05-19-11
